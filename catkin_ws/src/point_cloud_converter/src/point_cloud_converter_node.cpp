...
//This libraries included here might not be useful
...
//Con esto te evitas de tener que poner std:: delante de todo el codigo, indica que estas trabajando con el lenguaje estandar de c++
using namespace std;
...
private:
    ...
    //boost::mutex m_mutex_;  PREGUNTAR POR ESTA FUNCION,, HA COMPILADO BIEN TENIENDOLA COMENTADA
	 // ROS, aqui se crean los dos nodos de
    ros::NodeHandle nh_;
